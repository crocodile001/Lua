...
-- 人物圖片 ------------------------------------------------------------------------------------    
      ...
      main_actor.x = display.contentCenterX - 170
...
---- 按鈕事件 ---------------------------------------------
      ...
      local talk2 = function(event)
        ...
        timer.performWithDelay(2500,unlock)
      end
      ...
      local buttonHandler = function( event )
        if (lock == 0 and lock2 == 0 and lock3 == 0) then
          ...
          elseif (event.target.id == "village_headman" and i==1) then
            ...
            village_head = 1
          elseif (event.target.id == "villager" and i==1 and village_head == 1) then
            ...
            villager = 1; lock3 = 1
            timer.performWithDelay(2500,talk2)
            
          elseif( event.target.id == "door" and village_head == 1 and villager == 1) then
            lock3 = 1
...
-- 物品 ------------------------------------------------------------------
      ...
      local person2 = widget.newButton{
        id = "villager",
        defaultFile = "images/村民.png",
        onEvent = buttonHandler
      }
      
      local person3 = widget.newButton{
        id = "door",
        defaultFile = "images/門.png",
        onEvent = buttonHandler,
...
--      button4.x = display.contentCenterX-130; button4.y = display.contentCenterY+30; button4.width = 35; button4.height = 30; sceneGroup:insert(button4)
      person1.x = display.contentCenterX-50; person1.y = display.contentCenterY- 15; person1.width = 150; person1.height = 225; sceneGroup:insert(person1)
      person2.x = display.contentCenterX+80; person2.y = display.contentCenterY+35; person2.width = 200; person2.height = 300; sceneGroup:insert(person2)
      person3.x = display.contentCenterX+170; person3.y = display.contentCenterY- 10; person3.width = 110; person3.height = 150; sceneGroup:insert(person3)
-------------------------------------------------------------------------
